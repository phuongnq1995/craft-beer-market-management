<tiles:insertDefinition name="layouts">
	...
	<tiles:putAttribute name="header-link">
		<ol class="breadcrumb">
			...
			<li><a href="${pageContext.request.contextPath}/category/register"><i class="fa fa-plus"></i> <spring:message
						code="labels.category.new" /></a></li>
		</ol>
	</tiles:putAttribute>

	<tiles:putAttribute name="body">
		<form:form method="post" modelAttribute="categoryForm" action="${pageContext.request.contextPath}/category/register">
			<div class="row">
