<tiles:insertDefinition name="layouts">
	...
	<tiles:putAttribute name="header-link">
		<ol class="breadcrumb">
			...
			<li><a href="${pageContext.request.contextPath}/beer/register"><i class="fa fa-plus"></i> <spring:message
						code="labels.beer.new" /></a></li>
		</ol>
	</tiles:putAttribute>

	<tiles:putAttribute name="body">
		<form:form method="post" modelAttribute="beerForm" action="${pageContext.request.contextPath}/beer/register">
			<div class="row">
